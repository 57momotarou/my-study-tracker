...
function renderUpcoming(subjects, sem) {
  ...
  html+=`<p class="settings-note">動画・課題の両方を記録すると一覧から消えます。<button class="inline-link" onclick="progressView='learning';activatePage('progress',document.querySelector('[data-page=progress]'))">課題・期末を記録</button></p>`;
